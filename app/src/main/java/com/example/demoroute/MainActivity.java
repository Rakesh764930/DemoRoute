...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    {
        LatLng userLang=new LatLng(location.getLatitude(),location.getLongitude());
        MarkerOptions options=new MarkerOptions().position(userLang)
    ...
    String getDirectionUrl() {
        ...
        directionUrl.append("&destination="+destLat+","+destLong);
